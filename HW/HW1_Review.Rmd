...
2. Identify two cell lines => 가장 크고 작은 cell lines(행)을 찾아라..
  1. 일단 data에는 우리가 행은 단순 id이고 무슨 cell인지 모름.
  2. 그게 뭔지 알려면 labs를 써야함.
3. + 행을 찾고 동시에 values도 구하라.
...
# 조건에 따라 그룹 지정
e[cell_name %in% c("BREAST", "NSCLC")] = "A"
e[cell_name %in% c("MELANOMA", "OVARIAN", "PROSTATE")] = "B"
e[cell_name %in% c("LEUKEMIA", "RENAL", "UNKNOWN")] = "C"
